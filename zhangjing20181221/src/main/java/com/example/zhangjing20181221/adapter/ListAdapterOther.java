...
public class ListAdapterOther extends RecyclerView.Adapter<ListAdapterOther.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int i) {
        ...
        FlowAdapter adapter=new FlowAdapter(context);
        viewHolder.recyclerView.setAdapter(adapter);

        adapter.setOnLongItemClickListener(new FlowAdapter.onLongItemClickListener() {
            @Override
